...
function spawnObstacles(wave, size) {
    ...
    if (mod <= 2) {
        ...
        if (ok(off, off * 0.3))
            addArenaBlock(
                new THREE.Vector3(off, 0.5, off * 0.3),
                new THREE.Vector3(4 * s, 1, 4 * s),
                0x4a5a9a
            );
        if (ok(-off, -off * 0.3))
            addArenaBlock(
        ...
        if (ok(e, 0))
            addArenaBlock(
                new THREE.Vector3(e, 0.5, 0),
                new THREE.Vector3(3 * s, 1, 3 * s),
                0x4a5a9a
            );
        if (ok(-e, 0))
            addArenaBlock(
        ...
        if (ok(d, d))
            addArenaBlock(
                new THREE.Vector3(d, 0.5, d),
                new THREE.Vector3(5 * s, 1.5, 5 * s),
                0x5566aa
            );
        if (ok(-d, d))
            addArenaBlock(
        ...
        if (ok(0, e * 0.7))
            addArenaBlock(
                new THREE.Vector3(0, 1.0, e * 0.7),
                new THREE.Vector3(half * 0.8, 2, 1),
                0x3a5a7a
            );
        if (ok(0, -e * 0.7))
            addArenaBlock(
        ...
        if (ok(e * 0.7, 0))
            addArenaBlock(
                new THREE.Vector3(e * 0.7, 0.5, 0),
                new THREE.Vector3(1, 1, half * 0.6),
                0x3a5a7a
            );
        if (ok(-e * 0.7, 0))
            addArenaBlock(
        ...
        if (ok(0, e))
            addArenaBlock(
                new THREE.Vector3(0, 1.0, e),
                new THREE.Vector3(half * 0.5, 2, 1),
                0x3a5a7a
            );
        if (ok(0, -e))
            addArenaBlock(
